...
//	private SchoolClassHome sClassHome = null;
	...
	private ChildCareContractHome cccHome = null;
...
//	private Locale locale = null;
	 ...
	 * Default constructor.
	 */
	public NackaAfterSchoolFixFileHandlerBean() {}
		...
		try {
			...
			while (iter.hasNext()) {
				...
				if ((stId == 4) || (stId == 5) || (stId == 28)) {
					...
					while (iter2.hasNext()) {
						SchoolClassMember placement = (SchoolClassMember) iter2.next();
						if (placement.getSchoolTypeId() == afterSchoolTypeId) {
							afterSchoolPlacementId = ((Integer) placement.getPrimaryKey()).intValue();
							break;
						}
					}
